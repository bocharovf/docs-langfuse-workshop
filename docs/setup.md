...
Поэтому мы будем использовать платный сервис LLM от МТС Web Services - **GPT Model Hub**.
...
Чтобы его создать, перейдите в раздел **IAM -> Сервисные аккаунты** и нажмите **Создать**.
